...
public class DataSeeder {
    ...
    private Long criarClienteJdbc(JdbcTemplate jdbc, PasswordEncoder encoder, Object[] dados) {
        ...
        // Insere na tabela pai (usuario) recuperando a chave gerada de forma portável
        // (KeyHolder funciona tanto em PostgreSQL quanto em H2, ao contrário de RETURNING id).
