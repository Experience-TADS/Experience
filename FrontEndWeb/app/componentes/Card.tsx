...
export default function CardCar({ image, title, summary, onClick }: CardCarProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="group bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden cursor-pointer hover:shadow-xl transition duration-300 w-full border border-transparent dark:border-gray-700"
    >
      <div
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
          <span className="bg-white text-gray-900 px-3 py-1.5 rounded-lg text-xs sm:text-sm font-semibold shadow">
            Ver detalhes
          </span>
        </div>
      </div>
